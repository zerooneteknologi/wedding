...
<head>
  ...
  <title>Pages / Register - {{ config('app.name', 'Zero One')}}</title>
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Masukan detail data akun anda!</p>
                  </div>
                  ...
                  <form class="row g-3 needs-validation" novalidate method="POST" action="{{ route('register') }}">
                    ...
                    <div class="col-12">
                      ...
                      <div class="invalid-feedback">Masukan kembali password anda!</div>
                    ...
                    <div class="col-12">
                      <div class="form-check">
                        <input class="form-check-input" name="terms" type="checkbox" value="" id="acceptTerms" checked>
